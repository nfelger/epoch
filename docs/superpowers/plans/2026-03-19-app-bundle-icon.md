...
The icon echoes the app's arc dial UI: a thick circular arc stroke on an opaque background (see brainstorm: `docs/superpowers/brainstorms/2026-03-18-app-icon.md`).
