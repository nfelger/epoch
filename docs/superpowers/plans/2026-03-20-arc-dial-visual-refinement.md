...
**Note:** At 2+ stacked revolutions, tick visibility diminishes (0.8^2 = 64% opaque, 0.8^3 = 51%). This is acceptable — ticks are most useful during the first revolution. (see brainstorm: docs/superpowers/brainstorms/2026-03-20-arc-dial-visual-refinement.md)
