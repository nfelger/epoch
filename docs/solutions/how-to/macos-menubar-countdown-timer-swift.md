---
title: "Building Epoch: a native macOS menubar countdown timer with SwiftUI arc dial"
category: how-to
date: 2026-03-18
tags:
  - macos
  ...
  - nsstatusitem
  - countdown-timer
component: Epoch (standalone macOS menubar app)
key_files:
  - Epoch/AppDelegate.swift
  - Epoch/TimerModel.swift
  - Epoch/Views/ArcDialView.swift
...
- [Original brainstorm](../../brainstorms/2026-03-17-countdown-timer-menubar-app-brainstorm.md) — defines three-state model, arc dial design, completion behavior
- [Implementation plan](../../plans/2026-03-17-001-feat-epoch-menubar-countdown-timer-plan.md) — comprehensive technical plan with 15 numbered design iterations
