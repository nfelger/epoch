---
title: "Add .gitignore for Swift/Xcode project to exclude user-specific and build files"
...
tags:
  ...
  - xcuserdata
severity: "low"
component: "project-configuration/build-setup"
symptoms:
  - "xcuserdata/ files producing noisy diffs on every Xcode session"
  - "No .gitignore file present in repository"
  - "User-specific Xcode state files tracked in git"
---
...
No existing related solutions. This is the first entry in `docs/solutions/`.
